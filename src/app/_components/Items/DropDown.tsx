...
export default function DropDown({ isOpen, isbn13 }: DropDownProps) {
    return (
        <ul
            className={`fixed bottom-0 left-0 z-50 mt-2 w-full rounded-lg bg-white font-semibold shadow-lg transition-all duration-300 sm:absolute sm:bottom-auto sm:left-auto sm:right-0 sm:top-full sm:w-40 ${isOpen ? "visible translate-y-0 opacity-100" : "invisible translate-y-10 opacity-0"}`}>
            <li>
